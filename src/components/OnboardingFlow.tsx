  ...
  return (
    <div className="flex flex-wrap gap-2 p-3 bg-white border border-slate-200 rounded-lg focus-within:border-[#C2410C] focus-within:ring-1 focus-within:ring-[#C2410C] transition-all">
      {tags.map((tag) => (
        <span
          key={tag}
          className="inline-flex items-center px-2 py-1 rounded bg-slate-100 text-slate-900 text-xs font-medium border border-slate-200 animate-in fade-in zoom-in-95"
        >
          {Icon && <Icon className="w-3 h-3 mr-1.5 text-slate-400" />}
          {tag}
          <button
            onClick={() => onRemove(tag)}
            className="ml-1.5 text-slate-400 hover:text-rose-500 focus:outline-none"
          >
            <X className="w-3 h-3" />
          </button>
        </span>
...
export const OnboardingFlow: React.FC<OnboardingFlowProps> = ({
  ...
  >([
    ...
    {
      id: "2",
      text: "Filtering noise (Student/Career posts)...",
      status: "pending",
    },
    ...
    if (step === "launch") {
      ...
      (async () => {
        try {
          ...
          posthog.capture("product_onboarding_started", {
          ...
          posthog.capture("product_onboarding_completed", {
            product_name: formData.productName,
        ...
        <div className="w-full max-w-xl animate-in fade-in zoom-in-95 duration-500">
          ...
          <div className="space-y-4 min-h-[200px] pl-4 border-l-2 border-slate-100">
            {logs.map((log, i) => (
              <div
                key={i}
                className="flex items-center gap-3 text-slate-600 font-mono text-sm animate-in fade-in slide-in-from-left-2 duration-300"
              >
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-xl shadow-slate-200/50 overflow-hidden">
            <div className="p-8 md:p-10 space-y-8">
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-bold text-black uppercase tracking-widest font-mono">
                  Product Name
                </label>
                <input
                  type="text"
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setFormData((prev) => ({
                      ...prev,
                      painsFrustrations: e.target.value,
                    }))
                  }
              ...
              <div className="space-y-2">
                ...
                <TagInput
                  ...
                  onAdd={(t) =>
                    setFormData((prev) => ({
                      ...prev,
                      subreddits: [...prev.subreddits, t],
                    }))
                  }
                  onRemove={(t) =>
                    setFormData((prev) => ({
                      ...prev,
                      subreddits: prev.subreddits.filter((i) => i !== t),
                    }))
                  }
              ...
              <div className="space-y-2">
                ...
                <TagInput
                  ...
                  onAdd={(t) =>
                    setFormData((prev) => ({
                      ...prev,
                      keywords: [...prev.keywords, t],
                    }))
                  }
                  onRemove={(t) =>
                    setFormData((prev) => ({
                      ...prev,
                      keywords: prev.keywords.filter((i) => i !== t),
                    }))
                  }
              ...
              <div className="pt-6 border-t border-slate-100 flex items-center gap-3">
                ...
                <p className="text-sm text-slate-600">
                  Our agent is ready to monitor{" "}
                  <strong className="text-[#2C3E50] text-base">
                    {formData.subreddits.length}
                  </strong>{" "}
                  communities.
                </p>
              </div>
