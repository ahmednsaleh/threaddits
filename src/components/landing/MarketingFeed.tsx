...
const MOCK_LEADS = [
  {
    ...
    post_content:
      "I've been looking into both Threaddits and Leaddit. We need to start scaling our outreach on Reddit next week. Threaddits seems more autonomous, but Leaddit has been around longer. Does anyone have experience with both? Looking for the best ROI and least manual effort.",
    relevance_summary:
      "Direct comparison between Threaddits and a primary competitor. User is in the final decision-making phase.",
    problem_statement_detail:
      "Needs high-ROI, low-effort lead generation for immediate scaling.",
    urgency_signals_detail:
      "High - Decision needed by next week for upcoming sprint.",
  ...
  },
  {
    ...
    relevance_summary:
      "User has specific pain point (manual tracking) but price sensitive. Good candidate for mid-tier plan.",
        ...
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="bg-white border border-slate-200 p-4 rounded-xl shadow-sm flex flex-col justify-center">
              ...
              <div className="text-2xl font-mono font-bold text-[#2C3E50] tracking-tighter">
                1,240
              </div>
            </div>
            <div className="bg-white border border-slate-200 p-4 rounded-xl shadow-sm flex flex-col justify-center">
