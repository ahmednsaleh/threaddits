...
import { Search, Layout, Zap, ScanLine, Signal, ArrowDown } from "lucide-react";
...
const StatsRow = () => (
  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
    ...
    <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
      ...
      <div className="text-3xl font-mono font-bold text-amber-600 tracking-tighter">
        12
      </div>
    </div>
    <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
      ...
      <div className="text-3xl font-mono font-bold text-emerald-600 tracking-tighter">
        18
      </div>
    </div>
  </div>
  ...
  const leads: MockLead[] = [
    {
      ...
      summary:
        "Direct Intent. User is explicitly churning from a competitor and has budget. Perfect opportunity to position as the high-ROI choice.",
      content:
        "I've been using Baremetrics but the pricing is getting ridiculous for our stage. I need something cheaper than Baremetrics that still gives me good cohort analysis and high-fidelity metrics. We need to switch by next week.",
    ...
    },
    {
      ...
      timeAgo: "2h ago",
      title:
        "How are you guys handling custom cohort tracking? Spreadsheet is getting messy.",
      summary:
        "Indirect Intent. User has the specific pain point your tool solves but is not yet looking for a product. Opportunity to educate on automation.",
      content:
        "I'm currently trying to track our retention in Google Sheets but it's becoming a full-time job. How do people automate this without spending $500/mo on enterprise tools? Just looking for a simpler workflow.",
