        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-500 text-xl mt-4">
              Everything you need to know about the hunter.
            </p>
          </div>
          <div className="max-w-3xl mx-auto bg-white rounded-2xl border border-[#E2E8F0] p-10 shadow-sm">
            <div className="divide-y divide-[#E2E8F0]">
                ...
                answer={
                  <>
                    ...
                    <strong className="font-bold text-slate-900">
                      surgical listening tool
                    </strong>
                    , not a spam bot. We identify high-intent conversations and
                    draft the replies, but <em className="italic">you</em> take
                    the final action. Since you are posting manually (or
                    approving via our interface) and adding genuine value, you
                    remain 100% safe and compliant with Reddit's TOS.
                  </>
                }
              />
              <FAQItem
                ...
                answer={
                  <>
                    Never. Automation without supervision is the fastest way to
                    lose reputation. Threaddits acts as your{" "}
                    <strong className="font-bold text-slate-900">
                      Command Center
                    </strong>
                    —we find the lead and write the draft, but you hold the
                    trigger. This ensures your brand always sounds human, not
                    robotic.
                  </>
                }
              />
              <FAQItem
                ...
                answer={
                  <>
                    Keywords aren't enough. Someone saying "I hate HubSpot" is
                    different from "I need a HubSpot alternative." Our AI
                    analyzes{" "}
                    <strong className="font-bold text-slate-900">
                      sentiment and context
                    </strong>{" "}
                    to filter out complainers, students, and researchers,
                    delivering only leads with active buying intent.
                  </>
                }
              />
              <FAQItem
                ...
                answer={
                  <>
                    ...
                    . Instead of flooding you with 50 low-quality alerts,
                    Threaddits filters out 90% of the clutter. Expect fewer,
                    higher-quality notifications that are actually worth your
                    time to pursue.
                  </>
                }
              />
              <FAQItem
                ...
                answer={
                  <>
                    Absolutely. Reddit is the largest forum on the internet,
                    hosting thousands of professional communities like r/SaaS,
                    r/marketing, and r/sysadmin. It is currently the most
                    under-tapped channel for B2B customer acquisition.
                  </>
                }
              />
            </div>
