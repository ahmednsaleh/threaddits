                ...
                >
                    ...
                    <div className="flex flex-col min-w-0 gap-0.5">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[10px] font-mono text-slate-400 bg-slate-100 px-1.5 py-0.5 rounded shrink-0">
                          {lead.source_subreddit.startsWith("r/")
                            ? lead.source_subreddit
                            : `r/${lead.source_subreddit}`}
                        </span>
                        {lead.status === "New" && (
                          <div className="w-1.5 h-1.5 rounded-full bg-[#C2410C] shrink-0" />
                        )}
                      </div>
                  ...
                  <div className="shrink-0 pl-2 flex items-center gap-2">
                    <span className="text-[10px] text-slate-400 font-mono">
                      {formatTimeAgo(lead.created_utc)}
                    </span>
                    <Button
                      size="icon"
                      variant="ghost"
                      className="h-8 w-8 text-slate-300 group-hover:text-[#2C3E50] rounded-full"
                    >
          ...
          <div className="bg-white border border-slate-200 rounded-2xl shadow-sm flex flex-col">
            <div className="flex items-center justify-between px-6 py-5 border-b border-slate-100">
              ...
              <Button
                ...
                className="text-slate-400 hover:text-[#2C3E50] h-7 text-xs font-bold"
              >
                Manage
              </Button>
            </div>
            ...
            <div className="p-6 space-y-4">
              {isLoadingProducts ? (
                ...
                products.map((prod) => (
                  <div
                    key={prod.id}
                    className="p-4 rounded-xl border border-slate-200 bg-white hover:border-slate-300 transition-colors flex items-center justify-between group"
                  >
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-3 mt-1">
                          <span className="text-[10px] font-medium text-slate-500 font-mono flex items-center gap-1">
                            ...
                            {prod.subreddits?.length || 0} Subreddits
                          </span>
                          <span
                            className={cn(
                          ...
                          >
                            ...
                            {prod.status === "active" ? "Live" : "Paused"}
                          </span>
                        </div>
                      </div>
                    </div>
              ...
              <button
                onClick={() => navigate("/products")}
                className="w-full py-3 rounded-xl border border-dashed border-slate-200 text-slate-400 text-xs font-bold uppercase tracking-widest hover:bg-slate-50 hover:text-slate-600 transition-all flex items-center justify-center gap-2"
              >
